...
function AddEmployee(props) {
    ...
    return (
        <>
            <button onClick={handleShow} className="m-3 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                + Add Employee
            </button>
            ...
            >
                ...
                <Modal.Footer>
                    <button
                        onClick={handleClose} className="bg-slate-400 hover:bg-slateadded-700 text-white font-bold py-2 px-4 rounded">Close</button>
